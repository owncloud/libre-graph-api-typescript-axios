...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} userId key: id of user
         * @param {Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'mail' | 'mailNickname' | 'memberOf' | 'mobilePhone' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>} [$select] Select properties to be returned
         * @param {Set<'*' | 'drive' | 'drives' | 'memberOf'>} [$expand] Expand related entities
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getUser: async (userId: string, $select?: Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'mail' | 'mailNickname' | 'memberOf' | 'mobilePhone' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>, $expand?: Set<'*' | 'drive' | 'drives' | 'memberOf'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUser(userId: string, $select?: Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'mail' | 'mailNickname' | 'memberOf' | 'mobilePhone' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>, $expand?: Set<'*' | 'drive' | 'drives' | 'memberOf'>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getUser(userId: string, $select?: Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'mail' | 'mailNickname' | 'memberOf' | 'mobilePhone' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>, $expand?: Set<'*' | 'drive' | 'drives' | 'memberOf'>, options?: any): AxiosPromise<User> {
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public getUser(userId: string, $select?: Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'mail' | 'mailNickname' | 'memberOf' | 'mobilePhone' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>, $expand?: Set<'*' | 'drive' | 'drives' | 'memberOf'>, options?: AxiosRequestConfig) {
...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [$filter] Filter items by property values
         * @param {boolean} [$count] Include count of items
         * @param {Set<'id' | 'id desc' | 'deletedDateTime' | 'deletedDateTime desc' | 'accountEnabled' | 'accountEnabled desc' | 'businessPhones' | 'businessPhones desc' | 'city' | 'city desc' | 'companyName' | 'companyName desc' | 'country' | 'country desc' | 'createdDateTime' | 'createdDateTime desc' | 'department' | 'department desc' | 'displayName' | 'displayName desc' | 'faxNumber' | 'faxNumber desc' | 'givenName' | 'givenName desc' | 'lastPasswordChangeDateTime' | 'lastPasswordChangeDateTime desc' | 'legalAgeGroupClassification' | 'legalAgeGroupClassification desc' | 'mail' | 'mail desc' | 'mailNickname' | 'mailNickname desc' | 'memberOf' | 'mobilePhone' | 'mobilePhone desc' | 'officeLocation' | 'officeLocation desc' | 'onPremisesDistinguishedName' | 'onPremisesDistinguishedName desc' | 'onPremisesDomainName' | 'onPremisesDomainName desc' | 'onPremisesImmutableId' | 'onPremisesImmutableId desc' | 'onPremisesLastSyncDateTime' | 'onPremisesLastSyncDateTime desc' | 'onPremisesSamAccountName' | 'onPremisesSamAccountName desc' | 'onPremisesSyncEnabled' | 'onPremisesSyncEnabled desc' | 'onPremisesUserPrincipalName' | 'onPremisesUserPrincipalName desc' | 'postalCode' | 'postalCode desc' | 'preferredLanguage' | 'preferredLanguage desc' | 'state' | 'state desc' | 'streetAddress' | 'streetAddress desc' | 'surname' | 'surname desc' | 'usageLocation' | 'usageLocation desc' | 'userPrincipalName' | 'userPrincipalName desc' | 'userType' | 'userType desc' | 'aboutMe' | 'aboutMe desc' | 'birthday' | 'birthday desc' | 'preferredName' | 'preferredName desc'>} [$orderby] Order items by property values
         * @param {Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'licenseAssignmentStates' | 'mail' | 'mailNickname' | 'mobilePhone' | 'memberOf' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>} [$select] Select properties to be returned
         * @param {Set<'*' | 'drive' | 'drives' | 'memberOf'>} [$expand] Expand related entities
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listUsers: async ($top?: number, $skip?: number, $search?: string, $filter?: string, $count?: boolean, $orderby?: Set<'id' | 'id desc' | 'deletedDateTime' | 'deletedDateTime desc' | 'accountEnabled' | 'accountEnabled desc' | 'businessPhones' | 'businessPhones desc' | 'city' | 'city desc' | 'companyName' | 'companyName desc' | 'country' | 'country desc' | 'createdDateTime' | 'createdDateTime desc' | 'department' | 'department desc' | 'displayName' | 'displayName desc' | 'faxNumber' | 'faxNumber desc' | 'givenName' | 'givenName desc' | 'lastPasswordChangeDateTime' | 'lastPasswordChangeDateTime desc' | 'legalAgeGroupClassification' | 'legalAgeGroupClassification desc' | 'mail' | 'mail desc' | 'mailNickname' | 'mailNickname desc' | 'memberOf' | 'mobilePhone' | 'mobilePhone desc' | 'officeLocation' | 'officeLocation desc' | 'onPremisesDistinguishedName' | 'onPremisesDistinguishedName desc' | 'onPremisesDomainName' | 'onPremisesDomainName desc' | 'onPremisesImmutableId' | 'onPremisesImmutableId desc' | 'onPremisesLastSyncDateTime' | 'onPremisesLastSyncDateTime desc' | 'onPremisesSamAccountName' | 'onPremisesSamAccountName desc' | 'onPremisesSyncEnabled' | 'onPremisesSyncEnabled desc' | 'onPremisesUserPrincipalName' | 'onPremisesUserPrincipalName desc' | 'postalCode' | 'postalCode desc' | 'preferredLanguage' | 'preferredLanguage desc' | 'state' | 'state desc' | 'streetAddress' | 'streetAddress desc' | 'surname' | 'surname desc' | 'usageLocation' | 'usageLocation desc' | 'userPrincipalName' | 'userPrincipalName desc' | 'userType' | 'userType desc' | 'aboutMe' | 'aboutMe desc' | 'birthday' | 'birthday desc' | 'preferredName' | 'preferredName desc'>, $select?: Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'licenseAssignmentStates' | 'mail' | 'mailNickname' | 'mobilePhone' | 'memberOf' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>, $expand?: Set<'*' | 'drive' | 'drives' | 'memberOf'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/users`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const UsersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listUsers($top?: number, $skip?: number, $search?: string, $filter?: string, $count?: boolean, $orderby?: Set<'id' | 'id desc' | 'deletedDateTime' | 'deletedDateTime desc' | 'accountEnabled' | 'accountEnabled desc' | 'businessPhones' | 'businessPhones desc' | 'city' | 'city desc' | 'companyName' | 'companyName desc' | 'country' | 'country desc' | 'createdDateTime' | 'createdDateTime desc' | 'department' | 'department desc' | 'displayName' | 'displayName desc' | 'faxNumber' | 'faxNumber desc' | 'givenName' | 'givenName desc' | 'lastPasswordChangeDateTime' | 'lastPasswordChangeDateTime desc' | 'legalAgeGroupClassification' | 'legalAgeGroupClassification desc' | 'mail' | 'mail desc' | 'mailNickname' | 'mailNickname desc' | 'memberOf' | 'mobilePhone' | 'mobilePhone desc' | 'officeLocation' | 'officeLocation desc' | 'onPremisesDistinguishedName' | 'onPremisesDistinguishedName desc' | 'onPremisesDomainName' | 'onPremisesDomainName desc' | 'onPremisesImmutableId' | 'onPremisesImmutableId desc' | 'onPremisesLastSyncDateTime' | 'onPremisesLastSyncDateTime desc' | 'onPremisesSamAccountName' | 'onPremisesSamAccountName desc' | 'onPremisesSyncEnabled' | 'onPremisesSyncEnabled desc' | 'onPremisesUserPrincipalName' | 'onPremisesUserPrincipalName desc' | 'postalCode' | 'postalCode desc' | 'preferredLanguage' | 'preferredLanguage desc' | 'state' | 'state desc' | 'streetAddress' | 'streetAddress desc' | 'surname' | 'surname desc' | 'usageLocation' | 'usageLocation desc' | 'userPrincipalName' | 'userPrincipalName desc' | 'userType' | 'userType desc' | 'aboutMe' | 'aboutMe desc' | 'birthday' | 'birthday desc' | 'preferredName' | 'preferredName desc'>, $select?: Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'licenseAssignmentStates' | 'mail' | 'mailNickname' | 'mobilePhone' | 'memberOf' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>, $expand?: Set<'*' | 'drive' | 'drives' | 'memberOf'>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CollectionOfUser>> {
...
export const UsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listUsers($top?: number, $skip?: number, $search?: string, $filter?: string, $count?: boolean, $orderby?: Set<'id' | 'id desc' | 'deletedDateTime' | 'deletedDateTime desc' | 'accountEnabled' | 'accountEnabled desc' | 'businessPhones' | 'businessPhones desc' | 'city' | 'city desc' | 'companyName' | 'companyName desc' | 'country' | 'country desc' | 'createdDateTime' | 'createdDateTime desc' | 'department' | 'department desc' | 'displayName' | 'displayName desc' | 'faxNumber' | 'faxNumber desc' | 'givenName' | 'givenName desc' | 'lastPasswordChangeDateTime' | 'lastPasswordChangeDateTime desc' | 'legalAgeGroupClassification' | 'legalAgeGroupClassification desc' | 'mail' | 'mail desc' | 'mailNickname' | 'mailNickname desc' | 'memberOf' | 'mobilePhone' | 'mobilePhone desc' | 'officeLocation' | 'officeLocation desc' | 'onPremisesDistinguishedName' | 'onPremisesDistinguishedName desc' | 'onPremisesDomainName' | 'onPremisesDomainName desc' | 'onPremisesImmutableId' | 'onPremisesImmutableId desc' | 'onPremisesLastSyncDateTime' | 'onPremisesLastSyncDateTime desc' | 'onPremisesSamAccountName' | 'onPremisesSamAccountName desc' | 'onPremisesSyncEnabled' | 'onPremisesSyncEnabled desc' | 'onPremisesUserPrincipalName' | 'onPremisesUserPrincipalName desc' | 'postalCode' | 'postalCode desc' | 'preferredLanguage' | 'preferredLanguage desc' | 'state' | 'state desc' | 'streetAddress' | 'streetAddress desc' | 'surname' | 'surname desc' | 'usageLocation' | 'usageLocation desc' | 'userPrincipalName' | 'userPrincipalName desc' | 'userType' | 'userType desc' | 'aboutMe' | 'aboutMe desc' | 'birthday' | 'birthday desc' | 'preferredName' | 'preferredName desc'>, $select?: Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'licenseAssignmentStates' | 'mail' | 'mailNickname' | 'mobilePhone' | 'memberOf' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>, $expand?: Set<'*' | 'drive' | 'drives' | 'memberOf'>, options?: any): AxiosPromise<CollectionOfUser> {
...
export class UsersApi extends BaseAPI {
     ...
     * @memberof UsersApi
     */
    public listUsers($top?: number, $skip?: number, $search?: string, $filter?: string, $count?: boolean, $orderby?: Set<'id' | 'id desc' | 'deletedDateTime' | 'deletedDateTime desc' | 'accountEnabled' | 'accountEnabled desc' | 'businessPhones' | 'businessPhones desc' | 'city' | 'city desc' | 'companyName' | 'companyName desc' | 'country' | 'country desc' | 'createdDateTime' | 'createdDateTime desc' | 'department' | 'department desc' | 'displayName' | 'displayName desc' | 'faxNumber' | 'faxNumber desc' | 'givenName' | 'givenName desc' | 'lastPasswordChangeDateTime' | 'lastPasswordChangeDateTime desc' | 'legalAgeGroupClassification' | 'legalAgeGroupClassification desc' | 'mail' | 'mail desc' | 'mailNickname' | 'mailNickname desc' | 'memberOf' | 'mobilePhone' | 'mobilePhone desc' | 'officeLocation' | 'officeLocation desc' | 'onPremisesDistinguishedName' | 'onPremisesDistinguishedName desc' | 'onPremisesDomainName' | 'onPremisesDomainName desc' | 'onPremisesImmutableId' | 'onPremisesImmutableId desc' | 'onPremisesLastSyncDateTime' | 'onPremisesLastSyncDateTime desc' | 'onPremisesSamAccountName' | 'onPremisesSamAccountName desc' | 'onPremisesSyncEnabled' | 'onPremisesSyncEnabled desc' | 'onPremisesUserPrincipalName' | 'onPremisesUserPrincipalName desc' | 'postalCode' | 'postalCode desc' | 'preferredLanguage' | 'preferredLanguage desc' | 'state' | 'state desc' | 'streetAddress' | 'streetAddress desc' | 'surname' | 'surname desc' | 'usageLocation' | 'usageLocation desc' | 'userPrincipalName' | 'userPrincipalName desc' | 'userType' | 'userType desc' | 'aboutMe' | 'aboutMe desc' | 'birthday' | 'birthday desc' | 'preferredName' | 'preferredName desc'>, $select?: Set<'id' | 'deletedDateTime' | 'accountEnabled' | 'businessPhones' | 'city' | 'companyName' | 'country' | 'createdDateTime' | 'creationType' | 'department' | 'displayName' | 'faxNumber' | 'givenName' | 'lastPasswordChangeDateTime' | 'legalAgeGroupClassification' | 'licenseAssignmentStates' | 'mail' | 'mailNickname' | 'mobilePhone' | 'memberOf' | 'officeLocation' | 'onPremisesDistinguishedName' | 'onPremisesDomainName' | 'onPremisesImmutableId' | 'onPremisesLastSyncDateTime' | 'onPremisesSamAccountName' | 'onPremisesSyncEnabled' | 'onPremisesUserPrincipalName' | 'postalCode' | 'preferredLanguage' | 'state' | 'streetAddress' | 'surname' | 'usageLocation' | 'userPrincipalName' | 'userType' | 'aboutMe' | 'birthday' | 'preferredName' | 'drive' | 'drives'>, $expand?: Set<'*' | 'drive' | 'drives' | 'memberOf'>, options?: AxiosRequestConfig) {
