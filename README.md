# Libre Graph API TypeScript/Axios Client
...
# or
yarn add @owncloud/libre-graph-api-typescript-axios
```

### Usage

```typescript
import { Configuration, DrivesApi } from '@owncloud/libre-graph-api-typescript-axios';
...
This TypeScript client is used by [ownCloud Web](https://github.com/owncloud/web) to communicate with [oCIS](https://github.com/owncloud/ocis) via the Libre Graph API. It is generated from the [libre-graph-api](https://github.com/owncloud/libre-graph-api) OpenAPI spec.

This component is part of the [oCIS Docker image](https://hub.docker.com/r/owncloud/ocis).

## Community & Support

**[Star](https://github.com/owncloud/libre-graph-api-typescript-axios)** this repo and **Watch** for release notifications!
